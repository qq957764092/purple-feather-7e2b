...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/purple-feather-7e2b)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/purple-feather-7e2b
```

A live public deployment of this template is available at [https://purple-feather-7e2b.templates.workers.dev](https://purple-feather-7e2b.templates.workers.dev)
